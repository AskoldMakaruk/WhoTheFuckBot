...
namespace BotApi.Telegram
{
    public class Client
    {
        ...
        public async Task HandleInlineQueryChoosen(ChosenInlineResult result)
        {
            try
            {
        ...
        public async void OnInlineResultChosen(object sender, ChosenInlineResultEventArgs e)
        {
            var result = e.ChosenInlineResult;
            await HandleInlineQueryChoosen(result);
        }
